!function (a) {
    ...
    var h = a(".navbar-toggler"), p = a(".is-transparent");
    ...
    if (w.length > 0) {
        ...
        w.each(function () {
            var e = a(this), i = e.data("items") ? e.data("items") : 4, l = i >= 3 ? 2 : i, t = l >= 2 ? 1 : l,
                s = e.data("delay") ? e.data("delay") : 6e3, n = !!e.data("auto"), r = !!e.data("loop"),
                o = !!e.data("dots"), d = !!e.data("navs"), m = !!e.data("center"),
    ...
    P.length > 0 && P.each(function () {
        var e = a(this), i = e.parent(), l = e.data("overlay"), t = e.children("img").attr("src"),
    ...
    var j = a("#contact-form"), L = a("#subscribe-form");
    if (j.length > 0 || L.length > 0) {
        ...
        if (j.length > 0) {
            var S = j.find("select.required"), T = j.find(".form-results");
            j.validate({
                invalidHandler: function () {
                    T.slideUp(400)
                }, submitHandler: function (e) {
                    T.slideUp(400), a(e).ajaxSubmit({
                        target: T, dataType: "json", success: function (i) {
            ...
            L.validate({
                invalidHandler: function () {
                    ...
                    _.slideUp(400), a(e).ajaxSubmit({
                        target: _, dataType: "json", success: function (i) {
                            var l = "error" === i.result ? "alert-danger" : "alert-success";
    ...
    I.length > 0 && I.each(function () {
        ...
        particles: {
            ...
            line_linked: {enable: !0, distance: 150, color: "#2b56f5", opacity: .5, width: 1.3},
            move: {
                enable: !0,
                speed: 6,
                direction: "none",
